...
(async () => {
  ...
  if (hasReady) {
    // The second line of defense: proactively reset the animation time to zero - dealing with HTML that does not strictly adhere to the starter tick template
    // situation (for example, lastTick uses performance.now(), causing the font loading time to be included in the first frame dt)
