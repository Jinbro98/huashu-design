 ...
 *
 * Stage + Sprite mode, borrowed from Remotion but lightweight.
 *
 * Export (hung to window.Animations):
 * - Stage: the entire animation container, providing time + control
 * - Sprite: time segment, displayed within start/end, providing local progress
 ...
 *   </Stage>
 *
 * Use useSprite() in the Sprite subcomponent to read the current fragment progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // Quick start + slow braking to give digital elements a sense of physical weight
    expoOut: t => t === 1 ? 1 : 1 - Math.pow(2, -10 * t),
    // overshoot: flexible toggle/button popup (cubic-bezier(0.34, 1.56, 0.64, 1))
    overshoot: t => {
