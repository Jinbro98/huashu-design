...
// pages.jsx ← Covered with the same name!
...
Alternative:
```js
//Scroll to a certain position in the container
...
→ The version is wrong. Confirm that react-dom@18.3.1 is used (not 17 or other).
